...
def get_sample_entity_list() -> List[Dict]:
    ...
    return [
        SAMPLE_ENTITIES['peter_wimsey_1'],
        SAMPLE_ENTITIES['peter_wimsey_2'],
        SAMPLE_ENTITIES['harriet_vane']
    ]
...
def get_unique_entities() -> List[Dict]:
    ...
    return [
        SAMPLE_ENTITIES['harriet_vane'],
        SAMPLE_ENTITIES['jason_ohlendorf']
    ]
...
def get_mock_yaml_config():
    ...
    return {
        ...
        'entity_categories': {
            'person': {
                'patterns': ['person', 'driver', 'child'],
                'senzing_record_type': 'PERSON'
            },
            'organization': {
                'patterns': ['organization', 'org', 'agency'],
