      ...
      <div className="space-y-6">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <p className="mt-1 text-sm text-yellow-700">
                These administrative actions can permanently delete data. Use with caution. Always
                run a dry run first to see what will be affected.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Control validation behavior for XML and JSON file uploads. Changes take effect
            immediately.
          </p>
            ...
            <label className="flex items-center">
              ...
              <span className="ml-2 text-sm text-gray-700">
                ...
                <span className="ml-1 text-gray-500">
                  (applies to both XML ingestion and XML-to-JSON conversion)
                </span>
              </span>
            </label>
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center">
                  <input
                    ...
                    onChange={(e) =>
                      setResetOptions((prev) => ({ ...prev, data: e.target.checked }))
                    }
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <span className="ml-2 text-sm text-gray-700">
