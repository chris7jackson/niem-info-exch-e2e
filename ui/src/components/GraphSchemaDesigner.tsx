        ...
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Select which elements should become Neo4j nodes. Unselected elements will be flattened
              as properties.
            </p>
            {elementTree && (
              <p className="text-xs text-gray-500 mt-1">
                Schema: {elementTree.metadata.schema_name || schemaId} • {elementTree.total_nodes}{' '}
                elements
              </p>
            )}
          </div>
            ...
            <div className="flex items-start mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-red-700 mt-1">
                  Please fix the following issues before applying:
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start mb-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-yellow-800">
                  Design Warnings ({validationWarnings.length})
                </p>
                <p className="text-sm text-yellow-700 mt-1">
                  The following issues may affect analysis quality:
                </p>
              </div>
            </div>
        ...
        {!isLoading && elementTree && (
          <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between bg-gray-50">
            <div className="text-sm text-gray-600">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Tip: Select nodes you want to query independently. Unselected nodes will be
                flattened.
              </p>
            </div>
