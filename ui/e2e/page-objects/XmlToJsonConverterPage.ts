...
export class XmlToJsonConverterPage extends BasePage {
  ...
  async getConversionStats(): Promise<{
    ...
    const filesProcessedText = await resultsSection.locator('text=/Files Processed/i').locator('..').locator('div').first().textContent()
    const successfulText = await resultsSection.locator('text=/Successful/i').locator('..').locator('div').first().textContent()
    const failedText = await resultsSection.locator('text=/Failed/i').locator('..').locator('div').first().textContent()
